<main id="admin-page">
    ...
    <section class="admin-item-section">
        <div class="container">
            <form method="post" action="<?= BASE_URL . "barber/save" ?>" id="form-barber" class="delay-medium">
                <h2>Barbeiros</h2>

                <input type="text" name="id" id="barber_id" hidden>

                <div class="form-alert"></div>

                <div class="form-group interval-medium">
                    <label for="service_name">Nome</label>
                    <input type="text" id="barber_name" name="name" placeholder="Preencha aqui o nome" required>
                </div>


                <button class="btn-primary interval-medium" type="submit" title="Adicionar barbeiro">Adicionar barbeiro</button>
            </form>
            ...
            <div class="table-container delay-medium">
                <table>
                    ...
                    <tbody data-table-barbers></tbody>
                </table>
            </div>
        </div>
    </section>
    ...
    <section class="admin-item-section">
        <div class="container">
            <form method="post" action="<?= BASE_URL . "contact_info/save" ?>" id="form-contact-info" class="delay-medium">
