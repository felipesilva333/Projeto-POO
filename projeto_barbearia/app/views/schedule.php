<main id="schedule-page">
    ...
    <div class="container container-centered">
            <article>
                <h3 class="delay-small">1. Barbeiro: Selecione o Barbeiro de sua preferência</h3>

                <div class="barbers-container">
    <?php foreach ($barbers as $barber) : ?>
        <button class="barber interval-small" data-id="<?= $barber["id"] ?>" data-barber="<?= $barber["name"] ?>" title="Selecionar serviço">
            <h3><?= $barber["name"] ?></h3>
        </button>
    <?php endforeach ?>
</div>
            ...
            <div class="column">
                ...
                <div class="calendar">
                    <div class="calendar-header interval-small">
                        <div>
                            <button class="btn-primary btn-primary--dark btn-sm switch-left" title="Mês anterior">
                                <i class="bi bi-caret-left"></i>
                            </button>
                            <button class="btn-primary btn-primary--dark btn-sm switch-right" title="Próximo mês">
            ...
            <article>
                <form>
                    ...
                    <div class="form-group interval-small">
                        ...
                        <input type="text" id="username_message"  value="<?= $userData["name"] ?? "" ?>">
                    </div>
                    
                    <div class="form-group interval-small">
                        <label for="email_message">Email</label>
                        <input type="text" id="email_message"  value="<?= $userData["email"] ?? "" ?>">
                    </div>

                    <div class="form-group interval-small">
                        <label for="telephone_message">Telefone para contato </label>
                        <input type="tel" id="telephone_message" value="<?= $userData["tel"] ?? "" ?>">
                    </div>

                    <div class="form-group interval-small">
                        <label for="textarea_message">Escreva alguma mensagem para o barbeiro (opcional) </label>
                        <textarea id="textarea_message" rows="5" ></textarea>
                    </div>
